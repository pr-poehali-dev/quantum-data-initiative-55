        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Доска настроения — это не просто инструмент. Это живая среда для тех, кто думает образами: режиссёров, художников по костюмам, сценаристов, арт-директоров и всех, кто строит атмосферу руками.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы создали пространство, где идея «осеннее одиночество в большом городе» превращается в движущийся, звучащий, дышащий мир — понятный каждому в команде без единого слова объяснений.
            </p>
          </div>
        </div>
      </div>
