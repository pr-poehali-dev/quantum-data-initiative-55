        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Moodboard — это место для тех, кто мыслит образами. Мы верим, что у каждого чувства есть визуальный язык, и наша задача — помочь тебе его найти.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Дизайнер, художник, арт-директор или просто человек, ищущий красоту — здесь ты найдёшь своё племя и бесконечный источник вдохновения.
            </p>
          </div>
        </div>
      </div>
